...
class TestNetwork(object):
    ...
    def main(cls, args):
        ...
        given2 = {}
        given2[john]=True
        print("rejection sampling: " + str(alarmnet.performRejectionSampling(mary, given2, 999999)))
        print("weighted sampling: " + str(alarmnet.performWeightedSampling(mary, given2, 99999)))
        print("gibbs sampling: " + str(alarmnet.performGibbsSampling(mary, given2, 99999)))
